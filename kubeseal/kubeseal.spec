...
%changelog
* Fri Sep 11 2026 Johan Kok <johan@fedoraproject.org> - 0.40.0-1
- Bumped to 0.40.0

* Wed Dec 03 2025 Johan Kok <johan@fedoraproject.org> - 0.33.1-1
- Bumped to 0.33.1

* Fri Sep 12 2025 Johan Kok <johan@fedoraproject.org> - 0.32.0-1
- Bumped to 0.32.0

* Thu Aug 21 2025 Johan Kok <johan@fedoraproject.org> - 0.31.0-1
- Bumped to 0.31.0

* Mon Jun 09 2025 Johan Kok <johan@fedoraproject.org> - 0.29.0-1
- Bumped to 0.29.0

* Sun Mar 23 2025 Johan Kok <johan@fedoraproject.org> - 0.28.0-1
- Bumped to 0.28.0

* Tue Nov 12 2024 Johan Kok <johan@fedoraproject.org> - 0.27.2-1
- Bumped to 0.27.2
